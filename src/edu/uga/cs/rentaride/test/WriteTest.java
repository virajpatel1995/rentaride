...
public class WriteTest {
	...
	public static void main(String[] args) throws RARException {
        ...
        try {
        	Administrator admin1 = objectLayer.createAdministrator("Shep", "Ogden", "admin1", "sheppassword", "shepogden@uga.edu", "1 Dawg Drive", new Date("2017-10-05 10:00:00"));
        	...
        	persistence.storeVehicleTypeHourlyPrice(vehicleType1, hourlyPrice1);
        	...
        	persistence.storeVehicleTypeHourlyPrice(vehicleType2, hourlyPrice2);
